...
@NgModule({
    declarations: [RiskProfileComponent, CreateRiskProfileContainerComponent, ViewRiskProfileComponent],
    imports: [CommonModule, RiskProfileRoutingModule, ReactiveFormsModule, SvgCancelComponent, MessageComponent],
